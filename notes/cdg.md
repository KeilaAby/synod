...
| **EF-BUR-07** | **Dessiner** l'organigramme d'un bureau en React Flow : poser les fonctions applicables depuis une palette, les positionner librement, tracer les liens de dépendance, désigner un titulaire par glisser-déposer. Fonctions vacantes visibles. *(Révisé le 9 août 2026 : l'exigence disait « ordonné par rang protocolaire ». Le rang a été supprimé — voir `0022` — parce que l'organigramme se dessine désormais et que plus rien n'en dépendait. Chaque bureau porte sa propre hiérarchie dans `bureau_postes` ; l'ordre alphabétique classe les listes, sans prétendre exprimer une préséance.)* | **Must** |
...
| **EF-FIN-34** | **Import d'une feuille de versements** (Excel/CSV). Les noms et prénoms sont **rapprochés** du fichier des croyants comme à l'import de croyants (EF-CRO-11). Les lignes **sans correspondance** sont conservées et présentées dans une zone dédiée de `/croyants`, où elles se résolvent — rattachement à une fiche existante, ou création. | **Should** |
